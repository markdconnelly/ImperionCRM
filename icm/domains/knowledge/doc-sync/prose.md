...
between stages — never files. **Publish-to-IT-Glue is gated until trusted** — Lexicon
...
- **03 propose-diff** — produce the IT Glue diff (old → new) and route it for approval.
  This is the **gated** stage: the publish to the SoR parks for a human until Lexicon
