...
The canonical, human+machine SOP for this procedure (the full step contract, the seams,
the dormancy posture) is `sop.md` (ADR-0136 A8). v1 runs human-approves-all; the dial is
earned through the sub-procedure gates this sentinel routes to, not around them.
