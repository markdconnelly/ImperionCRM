...
const NO_CRED = { accountId: null, accountName: null, authMethod: null, certThumbprint: null, clientId: null, tokenIssuedAt: null, tokenExpiresAt: null };
...
export const companyConnections: ConnectionRow[] = [
  ...
  { id: "cn_13", scope: "company", provider: "m365", displayName: "Imperion M365 (enterprise app)", status: "active", scopes: ["Directory.Read.All"], owner: null, keyvaultSecretRef: "conn-company-m365", lastSync: "2026-06-06 06:30", connectedAt: "2026-01-05", pollIntervalMinutes: 1440, accountId: null, accountName: null, authMethod: "certificate", certThumbprint: "A1B2C3D4E5F6…", clientId: null, tokenIssuedAt: null, tokenExpiresAt: null },
  // Threads — a self-expiring long-lived token (FE #1502, epic #1334). Issued/expires demo the
  // 60-day lifecycle the card surfaces; the token itself stays in Key Vault, never the DB (§5).
  { id: "cn_14", scope: "company", provider: "threads", displayName: "Imperion Threads", status: "active", scopes: ["threads_basic", "threads_content_publish"], owner: null, keyvaultSecretRef: "conn-company-threads", lastSync: null, connectedAt: "2026-05-20", pollIntervalMinutes: 0, ...NO_CRED, tokenIssuedAt: "2026-05-20T09:00:00Z", tokenExpiresAt: "2026-07-19T09:00:00Z" },
];
...
export const clientConnections: ConnectionRow[] = [
  { id: "cn_20", scope: "client", provider: "m365", displayName: "Contoso M365 (tenant 1)", status: "active", scopes: ["Directory.Read.All"], owner: null, keyvaultSecretRef: "conn-client-contoso-t1-m365", lastSync: "2026-06-06 05:00", connectedAt: "2026-05-01", pollIntervalMinutes: 1440, accountId: "acc_contoso", accountName: "Contoso Ltd", authMethod: "secret", certThumbprint: null, clientId: "11111111-2222-3333-4444-555555555555", tokenIssuedAt: null, tokenExpiresAt: null },
];
