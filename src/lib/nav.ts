...
export const navBottom: NavItem[] = [
  ...
  { key: "feedback", label: "Feedback", icon: "Lightbulb", href: "/feedback" },
  {
    ...
    children: [
      ...
      { key: "settings-tenant-mapping", label: "Tenant mapping", icon: "Link2", href: "/settings/tenant-mapping" },
      { key: "settings-connections", label: "Global connections", icon: "Plug", href: "/settings/connections" },
