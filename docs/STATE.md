...
- `0256` `security_standard_version` + `posture_score` (Vera security-standard store, [#1715](https://github.com/markdconnelly/ImperionCRM/issues/1715); unblocks BE #439 / PR #469, pairs LP #399) — **authored, prod-apply pending** (deploy-dormant per ADR-0123)
