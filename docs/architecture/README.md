...
| [deep-dives/](deep-dives/README.md) | **The canonical deep dives, one layer at a time** — [medallion architecture](deep-dives/medallion-architecture.md) (data/kernel), [Open Knowledge Format](deep-dives/open-knowledge-format.md) (meaning/grounding cortex), and [how it all fits together](deep-dives/how-it-all-fits-together.md) (the synthesis), plus links to the sibling-repo deep dives (MWP/ICM, MemPalace, Open Brain). The public [papers](../../public/papers/executive-summary.html) link here. |
