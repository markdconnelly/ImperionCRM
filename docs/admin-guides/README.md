...
| Statuses | [Status administration](status-administration.md) — admin-definable task/project status sets per project type; reporting rolls up by category, not label (ADR-0065 B5, #616). |
| CMDB | [CI register](cmdb-ci-register.md) — read-only Configuration Item view (client account / end-user / device) projected over existing silver inventory; Imperion staff excluded (ADR-0078, epic #372, #645). |
