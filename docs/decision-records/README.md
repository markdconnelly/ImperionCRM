...
| [0013](./ADR-0013-feature-feedback-github.md) | Feature feedback coupled to GitHub | Accepted | 2026-06-07 | `feature_request` intake/voting in-app; accepted requests create GitHub Issues with one-way status sync back. |
