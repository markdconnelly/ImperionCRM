...
|---|---|
| **Repo** | frontend |
| **Status** | Superseded by [ADR-0078](./ADR-0078-feedback-files-to-app-dev-queue.md) (2026-06-11) |
| **Date** | 2026-06-07 |
| **Cross-references** | Superseded by ADR-0078 — feedback now files an Autotask ticket in the app-dev queue (#100) |
