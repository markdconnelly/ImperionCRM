...
| **Agent profile & procedure dial** | `agent_profile`, `agent_persona_section`, `procedure_human_owner`, `agent_procedure_policy`, `agent_autonomy_score` (view) | Diagram 3 | ADR-0141/0143 (mig 0261, #1832) |
| **Vera conformance engine** | `conformance_rule` (defined-way rules), `process_trace` (append-only audit input), `conformance_deviation` (#440 closure lifecycle) | Diagram 3 | mig 0257 (#1532); BE ADR-0103/0104 |
...
| **CMDB** | `cmdb_ci` (union read-model, #645), `ci_relationship` (edge layer, #647), `cmdb_ci_overlay` (per-CI criticality overlay, #648) | Diagram 4 | ADR-0078 (#372) |
