...
erDiagram
    ...
    PROJECT {
      ...
      uuid status_def_id FK "SET NULL — configurable status (9001, ADR-0065 B5)"
    ...
    STATUS_DEF {
      uuid id PK
      text scope "global|project_type (9001, ADR-0065 B5)"
    ...
    PROJECT_TYPE ||--o{ STATUS_DEF : "scopes status set (9001, ADR-0065 B5)"
