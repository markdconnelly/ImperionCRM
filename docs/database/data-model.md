...
erDiagram
    ...
    PROJECT {
      ...
      uuid status_def_id FK "SET NULL — configurable status (0105, ADR-0065 B5)"
    ...
    STATUS_DEF {
      uuid id PK
      text scope "global|project_type (0105, ADR-0065 B5)"
    ...
    PROJECT_TYPE ||--o{ STATUS_DEF : "scopes status set (0105, ADR-0065 B5)"
